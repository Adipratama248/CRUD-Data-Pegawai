...
<html lang="en">
  ...
  <body>
    ...
    <?php include "kon.php";
    $query_jabatan = mysqli_query($conn,"SELECT * FROM `tabel_jabatan`")
    ?>
              ...
              >
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="#" class="text-body"><h5><?= $data_jabatan['nama_j'] ?></h5></a>
                    </td>
                    <td>
                      <span class="mb-0">
                      <?php echo "Rp." , $data_jabatan['gaji_pokok'] ?>
                    </span>
                    </td>
                    <td>
                    <span class="mb-0">
                      <?php echo "Rp." , $data_jabatan['tunjangan'] ?>
                    </span>
                    </td>
                  </tr>
                  <?php } ?>
