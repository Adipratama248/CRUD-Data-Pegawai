...
?>
    <?php include "kon.php"; 
    $query_pegawai = mysqli_query($conn,"SELECT * FROM `tabel_pegawai` join `tabel_jabatan` on tabel_jabatan.id_j = tabel_pegawai.id_j")
    ?>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              <a class="nav-link active" aria-current="page" href="tampil_pegawai.php">Home</a>
              <a class="nav-link" href="tambah_pegawai1.php">Add new</a>
              <a class="nav-link" href="tampil_jabatan.php">List Jabatan</a>
              ...
              >
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="#" class="text-body"><h5><?= $data_pegawai['nama_pegawai'] ?></h5></a>
                    </td>
                    <td>
                      <span class="mb-0">
                      <?= $data_pegawai['nik'] ?>
                    ...
                    <td>
                      <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                          <a
                          href="ubah_pegawai1.php?id_pegawai=<?= $data_pegawai['id_pegawai'] ?>"
